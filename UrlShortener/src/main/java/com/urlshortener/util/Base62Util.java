...
public class Base62Util {
    ...
    private Base62Util(final byte[] alphabet) {
     ...
     */
    public static Base62Util createInstance() {
     ...
     * @return a {@link Base62} instance.
     */
    public static Base62Util createInstanceWithGmpCharacterSet() {
        return new Base62Util(CharacterSets.GMP);
    }
     ...
     * @return a {@link Base62} instance.
     */
    public static Base62Util createInstanceWithInvertedCharacterSet() {
        return new Base62Util(CharacterSets.INVERTED);
    }
